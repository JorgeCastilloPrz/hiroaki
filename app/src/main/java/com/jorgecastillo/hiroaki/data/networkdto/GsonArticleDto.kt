...
data class GsonNewsResponse(
        ...
        @SerializedName("articles") val articles: List<MoshiArticleDto>
)
...
data class GsonArticleDto(
        ...
        @SerializedName("source") val source: MoshiSourceDto
)
...
fun Article.toGsonDto() = GsonArticleDto(title, description, url, urlToImage, publishedAt, source.toMoshiDto())
